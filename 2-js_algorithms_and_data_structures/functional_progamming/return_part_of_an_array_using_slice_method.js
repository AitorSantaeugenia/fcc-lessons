...
It can take two arguments, the first gives the index of where to begin 
the slice, the second is the index for where to end the slice (and it's non-inclusive).
...
anim array given the provided beginSlice and endSlice indices. The function should return an array.
*/
