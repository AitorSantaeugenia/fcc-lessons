...
Sometimes when working with arrays, it is very handy to be able to iterate through each item to find one or
 more elements that we might need, or to manipulate an array based on which data items meet a certain set
  of criteria. JavaScript offers several built in methods that each iterate over arrays in slightly different
...
console.log([ [ 'trumpets', 2 ], [ 'flutes', 4 ], [ 'saxophones', 2 ] ], 2);
console.log([ [ 'amy', 'beth', 'sam' ], [ 'dave', 'sean', 'peter' ] ], 'peter');
